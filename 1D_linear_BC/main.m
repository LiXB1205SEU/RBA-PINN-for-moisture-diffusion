...
for epoch = 1: numEpochs
    ...
    while hasdata (mbq)
        ...
        [gradients, loss]  = dlfeval(@modelGradients, parameters, dlX, dlT, c);
...
%dlX_vector = linspace(0, 2, 100)
%dlX = dlarray(dlX_vector, 'CB')


%dlT_vector = linspace(0, 1, 100)
%dlT = dlarray(dlT_vector, 'CB')

%[dlU, Ux] = dlfeval(@modelU_deri,parameters,dlX,dlT)
